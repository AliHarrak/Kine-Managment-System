          ...
          <div class="content-wrapper">
                  ...
                  <div class="card-body py-0 px-0 px-sm-3">
                    <div class="row align-items-center">
                      ...
                      <div class="col-5 col-sm-7 col-xl-8 p-0">
                        <h4 class="mb-1 mb-sm-0">Want the Desktop Application?</h4>
                        <p class="mb-0 font-weight-normal d-none d-sm-block">Get our Desktop version with one button click!</p>
                      </div>
                      <div class="col-3 col-sm-2 col-xl-2 ps-0 text-center">
                        <span>
                          <a href="" target="_blank" class="btn btn-outline-light btn-rounded get-started-btn">Install Desktop App</a>
                        </span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-3">
                        <div class="icon icon-box-success ">
                          <p class="text-success ms-2 mb-0 font-weight-medium">23</p>                          
                        </div>
                      </div>
                    </div>
                    <h6 class="text-muted font-weight-normal">18% Higher than yesterday</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-3">
                        <div class="icon icon-box-success">
                        <p class="text-success ms-2 mb-0 font-weight-medium">6</p>
                          <span class="mdi mdi-arrow-top-right icon-item"></span>
                        </div>
                      </div>
                    </div>
                    <h6 class="text-muted font-weight-normal">5% higher than yesterday</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">$112.34</h3>
                          <p class="text-success ms-2 mb-0 font-weight-medium">+2.4%</p>
                        </div>
                      </div>
                      <div class="col-3">
                        <div class="icon icon-box-success">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h4 class="mb-0">Furniture stock</h4>
                  ...
                  <div class="card-body">
                    ...
                    <div class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                      ...
                      <div class="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0">
                        <h6 class="icon0 icon-box-success0 font-weight-bold mb-3">7</h6>
                      </div>
                    </div>
                    <div class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                      <div class="text-md-center text-xl-left">
                      ...
                      <div class="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0">
                        <h6 class="icon0 icon-box-danger0 font-weight-bold mb-3">19</h6>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="row ">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Booked Appointement</h4>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td> Dr. Jacob Williams </td>
                            <td> 11 Jul 2022 </td>
                             <td>
                              <div class="badge badge-outline-danger">Herniated Discs</div>
                            </td>
                            <td> 04 Dec 2019 </td>
                          ...
                          <tr>
                            ...
                            <td> Dr. Raheem Sterling </td>
                            <td> 13 Jul 2022 </td>
                           <td>
                              <div class="badge badge-outline-warning">Ankle Sprain</div>
                            </td>
                            <td> 04 Dec 2019 </td>
                          ...
                          <tr>
                            ...
                            <td> Dr. Togomori Okinawa </td>
                            <td> 30 Jun 2022 </td>
                             <td>
                              <div class="badge badge-outline-warning">Osteoarthritis</div>
                            </td>
                            <td> 04 Dec 2019 </td>
                          ...
                          <tr>
                            ...
                            <td> 13 Jul 2022 </td>
                           <td>
                              <div class="badge badge-outline-success"> Arthritis</div>
                            </td>
                            <td> 04 Dec 2019 </td>
                          ...
                          <tr>
                            ...
                            <td> 17 Nov 2022 </td>
                             <td>
                              <div class="badge badge-outline-danger">Spinal Stenosis</div>
                            </td>
                            <td> 04 Dec 2019 </td>
