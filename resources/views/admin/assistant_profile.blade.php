                            ...
                            <div class="col">
                                <nav aria-label="breadcrumb" class="rounded-3 p-3 mb-4">
                                    <ol class="breadcrumb mb-0">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Assistant Profile</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card mb-4">
                                    <div class="card-body text-center">
                                        <img src="doctorimage/{{$assistant->image}}" alt="avatar" class="rounded-circle img-fluid" style="width: 150px;">
                                        <h5 class="my-3">{{$assistant->name}}</h5>
                                        <p class="text-muted mb-1">Assistant ID: {{$assistant->id}} </p>
                                        <p class="text-muted mb-4">{{$assistant->speciality}}</p>
                                        <div class="d-flex justify-content-center mb-2">
                                            <a type="button" class="btn btn-primary" href="{{url('edit_assistant', $assistant->id)}}">Edit infos</a>
                                ...
                                <div class="card mb-4">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <p class="text-muted mb-0">{{$assistant->name}}</p>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <p class="text-muted mb-0">{{$assistant->speciality}}</p>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <p class="text-muted mb-0">{{$assistant->phone}}</p>
                                            </div>
                                        </div>
                                        <hr>
                                    </div>
