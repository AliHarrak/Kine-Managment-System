    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper" id="form_container">
            ...
            <div class="page-section">
                ...
                <div class="container">
                <a href="{{url('add_assistant_view')}}" class="btn btn-primary fadeInRight align-center" 
                                 style="width:18%; justify-content:center; margin-left:950px;">+ Add new Assistant</a>

                    <h1 class="text-center mb-5 wow fadeInUp"> Assistants List</h1>
                    ...
                    <div class="owl-carousel1 wow fadeInUP" id="doctorSlideshow">
                        ...
                        <div class="item">
                            <div class="card-doctor1" >
                                <div class="header1">
                                    <img width="300 px" src="doctorimage/{{$assistants->image}}" alt="" >
                                </div>
                                <div class="row justify-content-center" style="align-items:center ;">
                                    <div style="align-items:center;padding-left:55px;" class=" col-5">
                        
                                        <a href="{{url('edit_assistant', $assistants->id)}}" class="btn btn-primary btn-warning" style="padding-right:20px; margin-left:10px;">Edit</a>
                                    </div>
                                    <div class=" col-md-7 ">
                                        <form action="{{ url('/delete_assistant', ['id' => $assistants->id]) }}" method="post" onclick="return confirm('Are you sure you want to delete this assistant from the list ?')">
                                ...
                                <div class="body1">
                                <a href="{{url('assistant_profile_view', $assistants->id)}}" type="button" class="mdi mdi-account" style="padding-right:10px;"></a>
                                    <p class="text-xl mb-0" style="color: black;"> {{$assistants->name}}</p>
                                    <span class="text-sm" style="color: grey;"> {{$assistants->speciality}}</span>
                                </div>
                            </div>
                        </div>
                        @endforeach
